...
pdfmetrics.registerFont(TTFont('Arabic',  '/usr/share/fonts/truetype/freefont/FreeSerif.ttf'))
pdfmetrics.registerFont(TTFont('ArabicB', '/usr/share/fonts/truetype/freefont/FreeSerifBold.ttf'))
...
def build_pdf(d):
    ...
    ARB = ParagraphStyle('arb', fontName='ArabicB',               fontSize=8,   leading=11, alignment=2)
